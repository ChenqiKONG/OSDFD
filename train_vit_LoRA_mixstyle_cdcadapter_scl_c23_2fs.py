...
def parse_args():
    ...
    parser.add_argument('--val_csv_cat', default='./csv_files/100/c23_or_df_ff_nt_val.csv', type=str)

    parser.add_argument('--test_csv1', default='./csv_files/100/FS/c23/test.csv', type=str)
    parser.add_argument('--test_csv2', default='./csv_files/100/OR/c23/test.csv', type=str)
    parser.add_argument('--test_csv_cat', default='./csv_files/100/c23_or_fs_test.csv', type=str)

    parser.add_argument('--model_name', default="vit_lora_mixstyle_cdcadapter_scl_21k_c23_p0.2_2fs_3e-5_r16/", type=str)
