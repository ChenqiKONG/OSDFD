...
def parse_args():
    ...
    parser.add_argument('--val_csv_cat', default='./csv_files/100/c23_or_df_fs_nt_val.csv', type=str)

    parser.add_argument('--test_csv1', default='./csv_files/100/FF/c23/test.csv', type=str)
    parser.add_argument('--test_csv2', default='./csv_files/100/OR/c23/test.csv', type=str)
    parser.add_argument('--test_csv_cat', default='./csv_files/100/c23_or_ff_test.csv', type=str)

    parser.add_argument('--model_name', default="vit_lora_mixstyle_cdcadapter_scl_21k_c23_p0.2_2ff_3e-5_r16/", type=str)
