...
def parse_args():
    ...
    parser.add_argument('--train_csv_src1', default='./csv_files/100/DF/c23/train.csv', type=str)
    parser.add_argument('--train_csv_src2', default='./csv_files/100/FF/c23/train.csv', type=str)
    parser.add_argument('--train_csv_src3', default='./csv_files/100/FS/c23/train.csv', type=str)

    parser.add_argument('--val_csv0', default='./csv_files/100/OR/c23/val.csv', type=str)
    parser.add_argument('--val_csv1', default='./csv_files/100/DF/c23/val.csv', type=str)
    parser.add_argument('--val_csv2', default='./csv_files/100/FF/c23/val.csv', type=str)
    parser.add_argument('--val_csv3', default='./csv_files/100/FS/c23/val.csv', type=str)
    parser.add_argument('--val_csv_cat', default='./csv_files/100/c23_or_df_ff_fs_val.csv', type=str)

    parser.add_argument('--test_csv1', default='./csv_files/100/NT/c23/test.csv', type=str)
    parser.add_argument('--test_csv2', default='./csv_files/100/OR/c23/test.csv', type=str)
    parser.add_argument('--test_csv_cat', default='./csv_files/100/c23_or_nt_test.csv', type=str)

    parser.add_argument('--model_name', default="vit_lora_mixstyle_cdcadapter_scl_21k_c23_p0.2_2nt_3e-5_r16/", type=str)
